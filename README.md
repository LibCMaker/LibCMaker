 ...
 *Library*   | *GitHub Actions* <br> Linux <br> macOS <br> Windows_MSVC <br> Windows_MinGW_w64 <br> Android_on_Linux <br> Android_on_Windows <br> iOS | *Built with dependencies*
 ...
 [LibCMaker_SQLite3](https://github.com/LibCMaker/LibCMaker_SQLite3) <br> [SQLite3 site](https://www.sqlite.org/) | [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_SQLite3/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_SQLite3/actions/workflows/LibCMaker_CI.yml) | GTest, ICU (emedded in Skia)
 [LibCMaker_SQLiteModernCPP](https://github.com/LibCMaker/LibCMaker_SQLiteModernCPP) <br> [SQLiteModernCPP site](https://github.com/SqliteModernCpp/sqlite_modern_cpp) | [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_SQLiteModernCPP/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_SQLiteModernCPP/actions/workflows/LibCMaker_CI.yml) | GTest, ICU (emedded in Skia), SQLite3
