 ...
 *Library*   | *Travis CI* <br> Linux <br> Android <br> macOS <br> iOS   | *AppVeyor* <br> MSVC 2017 <br> MinGW-w64 <br> MSVC 2015   | *Built with dependencies*
 ...
 [LibCMaker_Cairo](https://github.com/LibCMaker/LibCMaker_Cairo) <br> [Cairo site](https://www.cairographics.org/) | [![Build Status](https://travis-ci.com/LibCMaker/LibCMaker_Cairo.svg?branch=master)](https://travis-ci.com/LibCMaker/LibCMaker_Cairo) | [![Build status](https://ci.appveyor.com/api/projects/status/github/LibCMaker/LibCMaker_Cairo?branch=master&svg=true)](https://ci.appveyor.com/project/NikitaFeodonit/libcmaker-cairo/branch/master) | GTest, zlib, libpng, Dirent (Windows only), Expat, #HarfBuzz (not yet), FreeType, FontConfig, Pixman
