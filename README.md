 ...
 *Library*   | *GitHub Actions* <br> Linux <br> macOS <br> Windows_MSVC <br> Windows_MinGW_w64 <br> Android_on_Linux <br> Android_on_Windows <br> iOS | *Built with dependencies*
 ...
 [LibCMaker_RmlUi](https://github.com/LibCMaker/LibCMaker_RmlUi) <br> [RmlUi site](https://github.com/mikke89/RmlUi) | [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_RmlUi/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_RmlUi/actions/workflows/LibCMaker_CI.yml) | GTest, Skia
 [LibCMaker_SDL2](https://github.com/LibCMaker/LibCMaker_SDL2) <br> [SDL2 site](https://libsdl.org/) | [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_SDL2/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_SDL2/actions/workflows/LibCMaker_CI.yml) | GTest, Skia
 [LibCMaker_SQLite3](https://github.com/LibCMaker/LibCMaker_SQLite3) <br> [SQLite3 site](https://www.sqlite.org/) | [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_SQLite3/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_SQLite3/actions/workflows/LibCMaker_CI.yml) | GTest, ICU (embedded in Skia)
 [LibCMaker_SQLiteModernCPP](https://github.com/LibCMaker/LibCMaker_SQLiteModernCPP) <br> [SQLiteModernCPP site](https://github.com/SqliteModernCpp/sqlite_modern_cpp) | [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_SQLiteModernCPP/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_SQLiteModernCPP/actions/workflows/LibCMaker_CI.yml) | GTest, ICU (embedded in Skia), SQLite3
 [LibCMaker_Skia](https://github.com/LibCMaker/LibCMaker_Skia) <br> [Skia site](https://skia.org/) | [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_Skia/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_Skia/actions/workflows/LibCMaker_CI.yml) | GTest, (Embedded: DNG SDK, Expat, FreeType, HarfBuzz, ICU, libjpeg, piex, libpng, libsvg, libwebp, zlib)
 ...
 [LibCMaker_ICU](https://github.com/LibCMaker/LibCMaker_ICU) <br> [ICU site](http://site.icu-project.org/) | Disabled [![LibCMaker CI](https://github.com/LibCMaker/LibCMaker_ICU/actions/workflows/LibCMaker_CI.yml/badge.svg)](https://github.com/LibCMaker/LibCMaker_ICU/actions/workflows/LibCMaker_CI.yml) | GTest
