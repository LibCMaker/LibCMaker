 ...
 *Library*   | *Travis CI* <br> Linux <br> Android <br> macOS <br> iOS   | *AppVeyor* <br> MSVC 2017 <br> MinGW-w64 <br> MSVC 2015   | *Built with dependencies*
 ...
 [LibCMaker_libpng](https://github.com/LibCMaker/LibCMaker_libpng) <br> [libpng site](http://www.libpng.org/pub/png/libpng.html) | [![Build Status](https://travis-ci.com/LibCMaker/LibCMaker_libpng.svg?branch=master)](https://travis-ci.com/LibCMaker/LibCMaker_libpng) | [![Build status](https://ci.appveyor.com/api/projects/status/github/LibCMaker/LibCMaker_libpng?branch=master&svg=true)](https://ci.appveyor.com/project/NikitaFeodonit/libcmaker-libpng/branch/master) | GTest
