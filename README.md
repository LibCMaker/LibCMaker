 ...
 *Library*   | *Travis CI* <br> Linux <br> Android <br> macOS <br> iOS   | *AppVeyor* <br> MSVC 2017 <br> MinGW-w64 <br> MSVC 2015   | *Built with dependencies*
 ...
 [LibCMaker_POCO](https://github.com/LibCMaker/LibCMaker_POCO) <br> [POCO site](https://pocoproject.org/) | [![Build Status](https://travis-ci.com/LibCMaker/LibCMaker_POCO.svg?branch=master)](https://travis-ci.com/LibCMaker/LibCMaker_POCO) | [![Build status](https://ci.appveyor.com/api/projects/status/github/LibCMaker/LibCMaker_POCO?branch=master&svg=true)](https://ci.appveyor.com/project/NikitaFeodonit/libcmaker-poco/branch/master) | GTest
